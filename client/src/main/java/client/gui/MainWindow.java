...
public class MainWindow extends JFrame {
    ...
    private JPanel buildCommandBar() {
        ...
        btnUpdate       = cmdBtn(lm.get("cmd.update"),          new Color(66, 135, 245));
        btnRemove       = cmdBtn(lm.get("cmd.remove"),          new Color(200,126,34));
        btnRemoveById   = cmdBtn(lm.get("cmd.remove_by_id"),    new Color(200,126,34));
        btnRemoveGreater= cmdBtn(lm.get("cmd.remove_greater"),  new Color(200,126,34));
        btnRemoveHead   = cmdBtn(lm.get("cmd.remove_head"),     new Color(200,126,34));
        btnHead         = cmdBtn(lm.get("cmd.head"),            new Color(66, 135, 245));
        btnClear        = cmdBtn(lm.get("cmd.clear"),           new Color(170,90,60));
        btnRemoveByPrice= cmdBtn(lm.get("cmd.remove_all_by_price"), new Color(200,126,34));
        btnRemoveByType = cmdBtn(lm.get("cmd.remove_any_by_type"),  new Color(200,126,34));
        btnMinByVenue   = cmdBtn(lm.get("cmd.min_by_venue"),    new Color(66, 135, 245));
        ...
        btnScript       = cmdBtn(lm.get("cmd.execute_script"),  new Color(90, 130, 200));
        btnLogout       = cmdBtn(lm.get("cmd.logout"),          new Color(200,76,60));
